...
set CMDS completion config fetchart fields fish ftintitle ? help imp im import lastgenre ls list mod modify mv move parentwork rm remove scrub spotify stats upd up update version write
...
# ------ fieldsetups for  parentwork -------
complete -c beet -n '__fish_beet_needs_command' -a parentwork -f -d 'fetch parent works, composers and dates'
complete -c beet -n '__fish_beet_using_command parentwork' -a '$FIELDS' -f -d 'fieldname'
...
# ====== completions for  parentwork =====
complete -c beet -n '__fish_beet_using_command parentwork' -s f -l force -f -d 're-fetch when parent work is already present'
complete -c beet -n '__fish_beet_using_command parentwork' -s h -l help -f -d 'print help'
